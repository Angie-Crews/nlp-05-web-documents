"""
src/nlp/stage02_validate_crews_p5.py - Validate Stage (Crews Phase 5)

Validates that the expected page structure is present for your crews phase 5 pipeline.
"""
...
def run_validate(
    ...
    LOG.info("========================")
    LOG.info("STAGE 02: VALIDATE starting (crews_p5)...")
    LOG.info("========================")
    ...
    LOG.info("VALIDATE: Primary subject found: %s", subjects is not None)
